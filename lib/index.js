...
// Cordis plugin providing Live Preview Sandbox server, SSE hot-reload, DOM click inspector, telemetry logs, standalone export, visual annotations, component galleries, workspace file watcher, props controls, visual diffs, and agent tools.

import { PreviewStore } from './store.js';
import { EventHub } from './events.js';
import { WorkspaceWatcher } from './watcher.js';
import { transpileAndWrap, buildStandaloneHtml, buildDiffWrapper } from './transpiler.js';
...
<body style="font-family:-apple-system,sans-serif;padding:32px;text-align:center;color:#666;">
  ...
  <p>Session ID <code>${canvasId || 'empty'}</code> does not exist or has expired.</p>
      ...
      // 4. API Endpoints for REST queries
