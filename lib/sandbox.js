// dsh-live-canvas: sandbox security, runtime injection, telemetry interceptor, visual annotation layer, and synchronized scroll.
...
export function injectSandboxRuntime(html, canvasId, options = {}) {
  ...
  const runtimeScript = `
<!-- dlc-sandbox-runtime: SSE auto-reload, DOM click inspector, error telemetry, visual annotations & sync scroll -->
