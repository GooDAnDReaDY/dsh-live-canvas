...
// --- Batch 2: Tools 15, 16, 17 ---
  ...
  ctx.tools.register(defineTool({
    ...
    description: 'Generates a Retool-style interactive CRUD admin dashboard with searchable table, status filters, add/edit modal, CSV export, and persistent localStorage database.',
    parameters: {
