...
.dlc-btn-danger { color:var(--dsw-alias-state-error-primary); border-color:rgba(239,68,68,0.3); }
.dlc-btn-active { background:var(--dsw-alias-state-brand-primary) !important; color:#ffffff !important; border-color:transparent !important; }
.dlc-btn-ai { background:var(--dsw-alias-state-brand-primary) !important; color:#ffffff !important; font-weight:600; border-color:transparent !important; }
.dlc-btn-err { border-color:var(--dsw-alias-state-error-primary) !important; color:var(--dsw-alias-state-error-primary) !important; }
.dlc-btn-reorder-active { background:rgba(245,158,11,0.12) !important; border-color:var(--dsw-alias-state-warning-primary) !important; color:var(--dsw-alias-state-warning-primary) !important; }
.dlc-btn-code-active { background:rgba(99,102,241,0.15) !important; border-color:var(--dsw-alias-state-brand-primary) !important; color:var(--dsw-alias-state-brand-primary) !important; }
...
.dlc-badge-ok { border-color:var(--dsw-alias-state-success-primary); color:var(--dsw-alias-state-success-primary); background:rgba(16,185,129,0.08); }
.dlc-badge-warn { border-color:var(--dsw-alias-state-warning-primary); color:var(--dsw-alias-state-warning-primary); background:rgba(245,158,11,0.08); }
.dlc-badge-bad { border-color:var(--dsw-alias-state-error-primary); color:var(--dsw-alias-state-error-primary); background:rgba(239,68,68,0.08); }
.dlc-banner-warning { padding:12px 16px; border-radius:8px; background:rgba(245,158,11,0.12); border:1px solid var(--dsw-alias-state-warning-primary); color:var(--dsw-alias-state-warning-primary); font-size:13px; display:flex; align-items:center; gap:10px; font-weight:500; }
.dlc-banner-exhausted { padding:12px 16px; border-radius:8px; background:rgba(239,68,68,0.12); border:1px solid var(--dsw-alias-state-error-primary); color:var(--dsw-alias-state-error-primary); font-size:13px; display:flex; align-items:center; gap:10px; font-weight:600; }
...
/* Code Drawer */
.dlc-code-drawer { width:420px; background:var(--dsw-alias-bg-layer-3); border-left:1px solid var(--dsw-alias-border-l2); display:flex; flex-direction:column; z-index:20; box-shadow:-4px 0 20px rgba(0,0,0,0.15); }
...
/* Blocks Modal */
.dlc-blocks-overlay { position:fixed; inset:0; background:rgba(0,0,0,0.5); backdrop-filter:blur(4px); z-index:50; display:flex; align-items:center; justify-content:center; padding:16px; }
.dlc-blocks-modal { background:var(--dsw-alias-bg-layer-3); border:1px solid var(--dsw-alias-border-l2); border-radius:14px; max-width:640px; width:100%; padding:20px; max-height:85vh; display:flex; flex-direction:column; box-shadow:0 12px 36px rgba(0,0,0,0.25); color:var(--dsw-alias-label-primary); }
...
.dlc-block-badge { padding:2px 8px; border-radius:999px; font-size:11px; font-weight:500; background:rgba(59,130,246,0.1); color:var(--dsw-alias-state-brand-primary); border:1px solid rgba(59,130,246,0.2); }
...
.dlc-matrix-card { background:var(--dsw-alias-bg-layer-3); border:1px solid var(--dsw-alias-border-l2); border-radius:12px; overflow:hidden; box-shadow:0 8px 24px rgba(0,0,0,0.15); flex-shrink:0; display:flex; flex-direction:column; }
...
.dlc-frame-wrapper { transition:width .25s ease-in-out, height .25s ease-in-out; border-radius:8px; box-shadow:0 8px 30px rgba(0,0,0,0.2); overflow:hidden; background:var(--dsw-alias-bg-layer-1); }
...
.dlc-modal-overlay { position:fixed; top:0; left:0; width:100vw; height:100vh; background:rgba(0,0,0,0.5); backdrop-filter:blur(4px); z-index:9999999; display:flex; align-items:center; justify-content:center; }
.dlc-modal-card { background:var(--dsw-alias-bg-layer-3); border:1px solid var(--dsw-alias-border-l2); border-radius:14px; width:480px; max-width:90vw; padding:20px; box-shadow:0 20px 50px rgba(0,0,0,0.25); display:flex; flex-direction:column; gap:14px; color:var(--dsw-alias-label-primary); font-family:-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif; }
...
`;
    ...
    const i18n = {
      ...
      ru: {
        ...
        reorderBtn: '↕️ D&D',
        codeBtn: '💻 Код',
        codeDrawerTitle: 'Исходный код',
        codeDrawerSync: 'Правки синхронизируются в реальном времени',
        codeDrawerLive: '● Live Sync',
        blocksModalTitle: '✨ Каталог готовых дизайн-блоков',
        insertBlockBtn: 'Вставить блок',
        reorderOnToast: 'Режим Drag & Drop включен: перетаскивайте секции',
        reorderOffToast: 'Режим Drag & Drop выключен',
        blockInsertedToast: 'Блок добавлен',
        codeSyncedToast: 'Код синхронизирован',
        themesLabel: '🎨 Тема',
        mockBtn: '⚡ Моки',
        shareBtn: '📱 QR',
        shareModalTitle: '📱 Мобильный предпросмотр по QR-коду',
        shareModalDesc: 'Отсканируйте камерой смартфона в локальной сети Wi-Fi:',
        copyShareLink: 'Скопировать ссылку',
        mockPopulatedToast: 'Мок-данные внедрены в песочницу',
        themeAppliedToast: 'Тема дизайн-системы применена',
        blueprintBtn: '📐 Вайрфрейм',
        artifactsBtn: '📋 Артефакты',
        artifactsModalTitle: '📋 Генератор интерактивных HTML-артефактов',
        wireframeArtifact: '📐 Low-Fi Вайрфрейм',
        planArtifact: '📋 Интерактивный Роадмап / План',
        diagramArtifact: '📊 Живая Архитектурная Схема',
        prototypeArtifact: '🧪 Многошаговый Прототип',
        resolveAnnotationBtn: '✓ Решено',
        annotationResolvedToast: 'Замечание помечено как решенное',
        deployBtn: '🌍 Деплой',
        timetravelBtn: '⏳ Таймлайн',
        soundBtn: '🔊 Звук',
        crudArtifact: '🗄️ Retool CRUD Панель',
        deployModalTitle: '🌍 Мгновенная публикация в Web',
        ...
        return React.createElement('li', { className: 'dlc-card' },
          React.createElement('div', { className: 'dlc-head' },
            React.createElement('div', null,
              ...
              React.createElement('div', { className: 'dlc-sub' }, t('loading'))
            )
          )
        );
      }
    ...
    function parseToolBlockData(block) {
      ...
      try {
        if (block) {
          ...
          if (raw) {
            ...
            if (args.layout) badgeText = '📐 Вайрфрейм (' + args.layout + ')';
            else if (args.version) badgeText = '📋 Роадмап ' + args.version;
            else if (args.diagramType) badgeText = '📊 Схема (' + args.diagramType + ')';
            else if (args.flowType) badgeText = '🧪 Прототип (' + args.flowType + ')';
      ...
      return { canvasId, previewUrl, title, badgeText };
    }
      ...
      const handleOpenStudio = () => {
        try {
          if (typeof window !== 'undefined') {
            localStorage.setItem('dsh_live_canvas_active_target', data.canvasId);
            window.dispatchEvent(new CustomEvent('dsh:open-live-canvas', { detail: { canvasId: data.canvasId } }));
            
            // Activate BetterSidebar tab
            const service = (ctx && ctx.get && ctx.get('betterSidebar')) || window.__dshBetterSidebar;
            if (service && typeof service.openTab === 'function') {
              service.openTab({ type: 'live-canvas', title: 'Live Canvas' });
            }
            setIsOpenInTab(true);
            setTimeout(() => setIsOpenInTab(false), 2500);
          }
        } catch (err) {
          console.warn('[LiveCanvas] Error opening sidebar tab:', err);
        }
      };

      return React.createElement('div', { className: 'dlc-chat-card' },
        React.createElement('div', { className: 'dlc-chat-card-head' },
          React.createElement('div', { className: 'dlc-chat-card-badge' }, data.badgeText),
          React.createElement('div', { className: 'dlc-chat-card-title' }, data.title)
        ),
        React.createElement('div', { className: 'dlc-chat-card-frame-box' },
        ...
        React.createElement('div', { className: 'dlc-chat-card-actions' },
          ...
          }, isOpenInTab ? '✓ Открыто в боковой панели!' : '🚀 Открыть в Live Canvas'),
    ...
    function LiveCanvasWorkspace(props) {
      ...
      const initialCanvasId = props.canvasId || parkedId || 'default';
      ...
      const toggleSound = () => {
        ...
        showToast(next ? '🔊 Звуковые эффекты включены' : '🔇 Звук отключен');
      };
      ...
      const handleInsertBlock = async (block) => {
        ...
        try {
          ...
          showToast(t('blockInsertedToast') || 'Блок вставлен');
        } catch {}
      };
      ...
      const handlePopulateMock = async (type = 'users') => {
        ...
        try {
          ...
          if (data.success && data.data) {
            ...
            showToast((t('mockPopulatedToast') || 'Мок-данные внедрены') + ' (' + endpoint + ')');
          }
        } catch {}
      };
      ...
      const handleCreateArtifact = async (type) => {
        ...
        const handleOpenEvent = (e) => {
          if (e && e.detail && e.detail.canvasId) {
            ...
            loadSessionsAndFiles();
            showToast('Холст открыт: ' + e.detail.canvasId);
          }
        };
        window.addEventListener('dsh:open-live-canvas', handleOpenEvent);
            showToast((t(type + 'Artifact') || type) + ' создан');
          }
        } catch {}
      };
      ...
      const handleResolveAnnotation = async (annId) => {
        ...
        try {
          ...
          showToast(t('annotationResolvedToast') || 'Замечание решено');
        } catch {}
      };
        ...
        fetch('/dsh-live-canvas/api/open-file', {
          ...
          .then(data => {
            if (data.canvasId) {
              ...
              showToast(`Открыт: ${data.title || filePath}`);
          ...
          .catch(err => {
            ...
            showToast(`Ошибка открытия: ${err.message || err}`);
          });
      };
      ...
      const selectedDropdownValue = currentFilePath
        ...
        : ((activeSession && activeSession.filePath)
            ...
            : (canvasId || (sessions[0] && sessions[0].id) ? activeId : 'default'));
      ...
      return React.createElement('div', { className: 'dlc-panel-container' },
        ...
        showConsole && React.createElement('div', { className: 'dlc-console-drawer' },
          logs.length === 0 ?
            React.createElement('div', { style: { color: 'var(--dsw-alias-label-secondary)' } }, t('noLogs')) :
    ...
    function registerNativeSidebar(nctx, rootCtx) {
      ...
      try {
        const def = {
          ...
          guide: [{
            order: 45,
            title: () => (ctx && ctx.locale && ctx.locale.getSnapshot && ctx.locale.getSnapshot().active?.startsWith('ru') ? 'Live Canvas' : 'Live Canvas'),
            description: () => (ctx && ctx.locale && ctx.locale.getSnapshot && ctx.locale.getSnapshot().active?.startsWith('ru')
              ? 'Интерактивный холст для предпросмотра HTML, React JSX, SVG и диаграмм'
    ...
    module.exports.apply = function apply(ctx) {
      ...
      // Settings Card Registration (settings.plugin.item only)
      if (ctx.slots && typeof ctx.slots.inject === 'function') {
        try {
          ...
          console.warn('[dsh-live-canvas] Failed to register settings card:', err);
        }
      }
