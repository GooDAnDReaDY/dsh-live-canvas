...
`;
    ...
    function PluginCard(props) {
      ...
      const scope = React.useMemo(() => {
        const settingsScope = readSettingsScope(ctx);
        if (!settingsScope || typeof settingsScope.bind !== "function") return null;
        try {
          return settingsScope.bind({ namespace: NS });
        } catch (_err) {
          return null;
        }
      }, [ctx]);
