...
`;
    ...
    function PluginCard(props) {
      ...
      if (props && props.view === 'summary') {
        return React.createElement('div', { className: 'dlc-sub' }, t('description'));
      }
    ...
    module.exports.apply = function apply(ctx) {
      ...
      // Settings Card Registration: row seat first (the seat the current core
      // renders), legacy settings.plugin.item after it as a fallback.
      if (ctx.slots && typeof ctx.slots.inject === 'function') {
        try {
