...
// Provides settings card in "Settings -> Plugins -> Plugin Settings" and Live Canvas interactive preview container.
...
`;
    ...
    const i18n = {
      en: {
        ...
        description: 'Interactive in-browser canvas for real-time preview of HTML (with Tailwind CSS & Lucide icons), React components, SVGs, and diagrams with SSE hot-reload.',
      ...
      ru: {
        title: 'Live Canvas Preview',
        description: 'Интерактивный холст для предпросмотра HTML (с Tailwind CSS и Lucide иконками), React-компонентов, SVG и диаграмм в реальном времени с поддержкой SSE hot-reload.',
